package com.lifs.infogempa.model

import com.google.gson.annotations.SerializedName

data class ResponseGempaPotensi(

	@field:SerializedName("Infogempa")
	val infogempa: Infogempa3? = null
)

data class GempaItem2(
...
data class Infogempa3(

	@field:SerializedName("gempa")
	val gempa: List<GempaItem2>? = null
)
